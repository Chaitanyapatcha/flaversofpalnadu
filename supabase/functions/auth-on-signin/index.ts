  ...
  try {
    ...
    const resendResp = await fetch("https://api.resend.com/emails", {
      ...
      body: JSON.stringify({
        ...
        to: email,
        subject: "New Login to Your Flavours of Palnadu Account",
        html: `<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
        ...
        <table width="600" cellpadding="0" cellspacing="0" border="0" style="max-width:600px; width:100%; background:#ffffff; border-radius:12px; overflow:hidden; box-shadow:0 4px 6px rgba(0,0,0,0.05);">
          ...
          <tr>
            <td style="padding:40px;">
              <h2 style="margin:0 0 16px; color:#1a1a1a; font-family:Arial,sans-serif; font-size:20px; font-weight:bold;">Hello, ${name}</h2>
              <p style="margin:0 0 16px; color:#4a4a4a; font-family:Arial,sans-serif; font-size:15px; line-height:1.6;">
                We noticed a new login to your Flavours of Palnadu account.
              </p>
              <p style="margin:0 0 24px; color:#4a4a4a; font-family:Arial,sans-serif; font-size:15px; line-height:1.6;">
                If this was you, no action is needed. If you didn't log in, please secure your account by changing your password immediately.
              </p>
              <table width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <td align="center">
                    <a href="${Deno.env.get("SITE_URL") || "https://flavoursofpalnadu.com"}/login" style="display:inline-block; background:#0a3d2e; color:#ffffff; text-decoration:none; padding:14px 32px; border-radius:8px; font-family:Arial,sans-serif; font-size:15px; font-weight:600;">Go to Your Account</a>
                  </td>
                </tr>
              </table>
